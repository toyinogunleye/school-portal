            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{url('admin/attendance/report')}}" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a  >
                  </div>
                </div>
            </div>
            </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         @if($value->created_at == $value->updated_at)
                                           ...
                                           @else
                                           <span style="color: red">{{ date('d-m-Y H:i A', strtotime($value->updated_at))}}</span>
                                        @endif
                                    </td>
                                </tr>
