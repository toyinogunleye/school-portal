        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header">
                <h3 class="card-title">Search Exam List </h3>
              </div>
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{url('admin/examination/exam-list')}}" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a  >
                  </div>
                </div>
            </div>
            </form>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/examination/edit-exam/'.$value->id)}}" class="btn btn-primary">Edit</a>
                             <a href="{{url('admin/examination/delete-exam/'.$value->id)}}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    @endforeach
