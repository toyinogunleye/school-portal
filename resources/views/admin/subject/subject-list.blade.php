      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
              <a href="{{url('admin/subject/add-subject')}}" class="btn btn-primary">Add New Subject</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" title="Edit" href="{{url('admin/subject/edit/'.$value->id)}}" ><i class="fas fa-pencil-alt"></i> </a>
                            <a class="btn btn-danger btn-sm" title="Delete"  href="{{url('admin/subject/delete/'.$value->id)}}"><i class="fas fa-trash"> </i>  </a>
