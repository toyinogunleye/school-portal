        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header">
                <h3 class="card-title">Search Homework Report List</h3>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown" style="margin-top: -20px">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Search Homework Report List</span>
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{url('admin/homework/homework-report')}}" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a>
                  </div>
                </div>
            </div>
            </form>
              ...
              <div class="card-body p-0" style="overflow: auto;">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>{{$i++}}</td>
                        <td>{{$value->first_name}} {{$value->first_name}} {{$value->first_name}}</td>
