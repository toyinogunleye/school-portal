                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-2">
                   ...
                   <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" value="{{Request::get('created_by')}}" name="created_by" placeholder="Enter Name">
                  </div>
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{url('admin/homework/homework')}}" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a>
                  </div>
                </div>
            </div>
            </form>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('admin/homework/edit-homework/'.$value->id)}}" class="btn btn-primary btn-sm">Edit</a>
                             <a href="{{url('admin/homework/delete-homework/'.$value->id)}}" class="btn btn-danger btn-sm">Delete</a>
                            <a href="{{url('admin/homework/submitted-homework/'.$value->id)}}" class="btn btn-success btn-sm">Submitted Homework</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
