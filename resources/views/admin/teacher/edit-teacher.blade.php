                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" class="form-control" value="{{old('middle_name', $getRecord->middle_name)}}" name="middle_name" required placeholder="Enter Middle Name">
                        ...
                        <div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-4">
                            ...
                            <input type="text" class="form-control" value="{{old('guarantor_name', $getRecord->guarantor_name)}}" name="guarantor_name" required placeholder="FirstName, Surname">
                             <div style="color: red">{{$errors->first('guarantor_name')}}</div>
                        </div>
                         <div class="form-group col-sm-4">
                            <label>Guarantor's Number <span style="color: red">*</span></label>
                            <input type="number" class="form-control" value="{{old('guarantor_number', $getRecord->guarantor_number)}}" name="guarantor_number" required placeholder="Enter Guarantor Number">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-4">
                            ...
                            <select class="form-control" required name="marital_status">
                                ...
                                <option {{(old('marital_status', $getRecord->marital_status)=='Others')? 'selected': ''}} value="Others">Others</option>
                            </select>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {{-- <textarea class="form-control" value="{{old('caste')}}" name="caste" placeholder="Enter Caste" ></textarea> --}}
                            <input type="text" class="form-control" value="{{old('permanent_address', $getRecord->permanent_address)}}" name="permanent_address" required placeholder="Enter Permanent Address">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <select class="form-control" required name="qualification">
                                ...
                                <option {{(old('qualification', $getRecord->qualification)=='SSCE')? 'selected': ''}} value="SSCE">SSCE</option>
                                <option {{(old('qualification', $getRecord->qualification)=='NCE')? 'selected': ''}} value="NCE">NCE</option>
                                <option {{(old('qualification', $getRecord->qualification)=='Diploma')? 'selected': ''}} value="Diploma">Diploma</option>
                                <option {{(old('qualification', $getRecord->qualification)=='Degree')? 'selected': ''}} value="Degree">Degree</option>
                                <option {{(old('qualification', $getRecord->qualification)=='Masters')? 'selected': ''}} value="Masters">Masters</option>
                                <option {{(old('qualification', $getRecord->qualification)=='Doctorate')? 'selected': ''}} value="Doctorate">Doctorate</option>
                                <option {{(old('qualification', $getRecord->qualification)=='Others')? 'selected': ''}} value="Others">Others</option>
                            </select>
                             <div style="color: red">{{$errors->first('gender')}}</div>
                        </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            {{-- <textarea class="form-control" value="{{old('caste')}}" name="caste" placeholder="Enter Caste" ></textarea> --}}
                            <input type="text" class="form-control" value="{{old('work_experience', $getRecord->work_experience)}}" name="work_experience" required placeholder="Year of Work Experience">
                            <div style="color: red">{{$errors->first('work_experience')}}</div>
                        </div>
                         <div class="form-group col-sm-4">
                            <label>Employment Date <span style="color: red">*</span></label>
                            <input type="date" class="form-control" value="{{old('employment_date', $getRecord->employment_date)}}" name="employment_date" required>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <select class="form-control" required name="status">
                                ...
                                <option {{(old('status', $getRecord->state)== 0)? 'selected': ''}} value="0">Active</option>
                                <option {{(old('status', $getRecord->state)== 1)? 'selected': ''}} value="1">Inactive</option>
                            </select>
