          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body box-profile">
                  ...
                  <img class="profile-user-img img-fluid img-circle" src="{{$getRecord->getProfile()}}" alt="Profile picture">
                  @else
                  <img class="profile-user-img img-fluid img-circle" src="{{ asset('public/upload/profile/default-profile.png') }}" alt="Profile picture">
                   @endif
                </div>
                <h3 class="profile-username text-center">{{$getRecord->name }} {{$getRecord->middle_name }} {{$getRecord->last_name }}</h3>

                <p class="text-muted text-center">{{$getRecord->$getClassList->class_name}} Hello</p>
