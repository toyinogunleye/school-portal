                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-sm-4">
                            ...
                            <select class="form-control" required name="genotype">
                                ...
                                <option {{(old('genotype', $getRecord->genotype)=='AA')? 'selected': ''}}  value="AA">AA</option>
                                <option {{(old('genotype', $getRecord->genotype)=='AS')? 'selected': ''}}  value="AS">AS</option>
                                <option {{(old('genotype', $getRecord->genotype)=='SS')? 'selected': ''}}  value="SS">SS</option>
                                <option {{(old('genotype', $getRecord->genotype)=='SC')? 'selected': ''}}  value="SC">SC</option>
                            </select>
                        </div>
                         <div class="form-group col-sm-4">
                            ...
                            <select class="form-control" required name="blood_group">
                                <option value="">Select Blood Group</option>
                                 ...
                                 <option {{(old('blood_group', $getRecord->blood_group)=='AB+')? 'selected': ''}} value="AB+">AB+</option>
                                 <option {{(old('blood_group', $getRecord->blood_group)=='O-')? 'selected': ''}} value="O-">O-</option>
                                 <option {{(old('blood_group', $getRecord->blood_group)=='A-')? 'selected': ''}} value="A-">A-</option>
                                 <option {{(old('blood_group', $getRecord->blood_group)=='B-')? 'selected': ''}} value="B-">B-</option>
                                 <option {{(old('blood_group', $getRecord->blood_group)=='AB-')? 'selected': ''}} value="AB-">AB-</option>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="date" class="form-control" value="{{old('admission_date', $getRecord->admission_date)}}" name="admission_date" required placeholder="Enter Admission Date">
