    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown" style="margin-top: -20px">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Search Student Homework</span>
          ...
          <div class="dropdown-divider"></div>
          <a href="{{url('parent/my-student/homework/'.$getStudent->id)}}" class="dropdown-item dropdown-footer">See All Homeworks</a>
        </div>
      </li>
