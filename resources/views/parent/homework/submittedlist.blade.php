        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Student Submitted Homework</h1>
             <p>Student Name: <span style="color: blue;">{{$getStudent->first_name}} {{$getStudent->middle_name}} {{$getStudent->last_name}}</span></p>
          </div>
          <div class="col-sm-6" style="text-align: right;">
              <a href="{{url('parent/homework/submitted-homework')}}" class="btn btn-primary">Submitted Homeworks</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <form method="get" action="">
            ...
            <div class="form-group col-md-12">
                    ...
                    <a href="{{url('student/my-submitted-homework')}}" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a>
            </div>
          </form>
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{url('/parent/my-student/submitted-homework/'.$getStudent->id)}}" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a>
                  </div>
                </div>
            </div>
            </form>
