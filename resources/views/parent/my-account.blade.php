            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Occupation</b> <a class="float-right">{{$getRecord->occupation}}</a>
                  </li>
                </ul>

                <a href="{{url('admin/parent/edit-parent/'.$getRecord->id)}}" class="btn btn-primary btn-block"><b>Edit Profile</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
